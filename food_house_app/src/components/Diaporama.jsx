...
const Diaporama = () => {
  return (
    ...
    >
      <SwiperSlide>
        <img src="https://pizzeria-vendeuvre.fr/wp-content/uploads/2022/04/header-pizzas.jpg"  alt="pizza" className='item' />
      </SwiperSlide>
      <SwiperSlide>
        <img src="https://pizzeria-vendeuvre.fr/wp-content/uploads/2022/04/PJ2202-0099-Lucasson-Frederic-header-boutique.jpg" alt="pizza" className='item' />
      </SwiperSlide>
      <SwiperSlide>
        <img src="https://zoneboreale.com/app/uploads/2024/10/fromagerie-st-laurent.jpg" alt="pizza" className='item' />
      </SwiperSlide>
    </Swiper>
  );
};
