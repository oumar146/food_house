    ...
    <header className="bg-white color-red">
      ...
      >
        ...
        <PopoverGroup className="hidden sm:flex sm:gap-x-12">
          <a href="#menu" className="nav-link font-semibold text-gray-900">
            Menu
          </a>
          <a href="#" className=" nav-link font-semibold text-gray-900">
            A propos de nous
          </a>
          <a href="#" className=" nav-link font-semibold text-gray-900">
            Company
        ...
        <div className="hidden sm:flex lg:flex-1 lg:justify-end">
          <a href="#" className=" nav-link text-xs font-semibold text-gray-900">
